          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 lg:gap-8 gap-12 pt-14 pb-20 max-w-md mx-auto md:max-w-xl lg:max-w-full">
            ...
            <div className="block">
              ...
              <ul className="text-lg transition-all duration-500">
                ...
                <li>
                  <Link href="/pro-version" className="text-gray-400 hover:text-white">
                    Pro Version
                  </Link>
                </li>
              </ul>
            ...
            <div className="block">
              ...
              <ul className="text-lg transition-all duration-500">
                <li className="mb-6">
                  <Link href="/products/figma-ui" className="text-gray-400 hover:text-white">
                    Figma UI System
                  </Link>
                </li>
                <li className="mb-6">
                  <Link href="/products/icons" className="text-gray-400 hover:text-white">
                    Icons Assets
                  </Link>
                </li>
                <li className="mb-6">
                  <Link href="/products/responsive-blocks" className="text-gray-400 hover:text-white">
                    Responsive Blocks
                  </Link>
                </li>
                <li className="mb-6">
                  <Link href="/products/components" className="text-gray-400 hover:text-white">
                    Components Library
                  </Link>
                </li>
                <li>
                  <Link href="/products/plugin-guide" className="text-gray-400 hover:text-white">
                    Plugin Guide
                  </Link>
                </li>
              </ul>
            ...
            <div className="block">
              ...
              <ul className="text-lg transition-all duration-500">
                ...
                <li className="mb-6">
                  <Link href="/quick-start" className="text-gray-400 hover:text-white">
                    Quick Start
                  </Link>
                </li>
                <li className="mb-6">
                ...
                <li className="mb-6">
                  <Link href="/user-guide" className="text-gray-400 hover:text-white">
                    User Guide
                  </Link>
                </li>
                <li>
                  <Link href="/plugin-guide" className="text-gray-400 hover:text-white">
                    Plugin Guide
                  </Link>
                </li>
              </ul>
            ...
            <div className="flex items-center justify-center flex-col lg:space-y-0 space-y-8 lg:justify-between lg:flex-row">
              ...
              <div className="flex mt-4 space-x-4 sm:justify-center sm:mt-0">
                ...
                >
                  ...
                  >
                    <path
                      d="M4.70975 7.93663C4.70975 6.65824 5.76102 5.62163 7.0582 5.62163C8.35537 5.62163 9.40721 6.65824 9.40721 7.93663C9.40721 9.21502 8.35537 10.2516 7.0582 10.2516C5.76102 10.2516 4.70975 9.21502 4.70975 7.93663ZM3.43991 7.93663C3.43991 9.90608 5.05982 11.5025 7.0582 11.5025C9.05658 11.5025 10.6765 9.90608 10.6765 7.93663C10.6765 5.96719 9.05658 4.37074 7.0582 4.37074C5.05982 4.37074 3.43991 5.96719 3.43991 7.93663ZM9.97414 4.22935C9.97408 4.39417 10.0236 4.55531 10.1165 4.69239C10.2093 4.82946 10.3413 4.93633 10.4958 4.99946C10.6503 5.06259 10.8203 5.07916 10.9844 5.04707C11.1484 5.01498 11.2991 4.93568 11.4174 4.81918C11.5357 4.70268 11.6163 4.55423 11.649 4.39259C11.6817 4.23095 11.665 4.06339 11.6011 3.91109C11.5371 3.7588 11.4288 3.6286 11.2898 3.53698C11.1508 3.44536 10.9873 3.39642 10.8201 3.39635H10.8197C10.5955 3.39646 10.3806 3.48424 10.222 3.64043C10.0635 3.79661 9.97434 4.00843 9.97414 4.22935ZM4.21142 13.5892C3.524 13.5892 2.9668 13.032 2.9668 12.3446V3.52866C2.9668 2.84126 3.524 2.28406 4.21142 2.28406H13.0286C13.716 2.28406 14.2732 2.84126 14.2732 3.52866V12.3446C14.2732 13.032 13.716 13.5892 13.0286 13.5892H4.21142Z"
                      fill="currentColor"
                    />
                  </svg>
                </a>
